...
specs_ori = cv2.imread('Mask2web.png',-1)
cigar_ori = cv2.imread('fish.png',-1)
...
def transparentOverlay(src, overlay, pos=(0, 0), scale=1):
    ...
    y, x = pos[0]+300, pos[1]+350  # Position of foreground/overlay image
...
while 1:
    ...
    for (x, y, w, h) in faces:
        if h > 0 and w > 0:
            ...
            face_glass_roi_color = img
            print(face_glass_roi_color)
            ...
            specs = cv2.resize(specs_ori, (w, sh_glass*4),interpolation=cv2.INTER_CUBIC)
